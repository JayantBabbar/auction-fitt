...
import { Upload, Users, Download, Key } from 'lucide-react';
...
const BulkUserCreation = () => {
  ...
  const createUser = async (user: User): Promise<boolean> => {
    try {
      ...
      if (!response.ok) {
        ...
        console.error('Clerk API error for', user.email, ':', error);
        return false;
      }
  ...
  const generateSampleUsers = () => {
    ...
    toast({
      ...
      description: "Generated 80 sample users. Edit the CSV data as needed.",
    });
  };
  ...
  const handleBulkUpload = async () => {
    ...
    if (errors.length > 0) {
      console.log('Failed users:', errors);
    }
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create multiple users at once using CSV data. Perfect for adding 80+ users.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button 
                  ...
                  className="flex-1"
                >
                  {isBulkUploading ? 'Creating Users...' : (
                    <>
